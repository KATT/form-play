...
type ApiSubmission = {
  endpoint: string
  method: 'POST' | 'PATCH'
  body: ReturnType<typeof toApiPayload>
}
      ...
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[minmax(0,1fr)_420px]">
        <section>
          ...
          <p className="mt-4 max-w-3xl text-slate-300">
            This single route models a create/edit bill form. It handles fresh
            defaults, defaults mapped from an API bill, conditional fields for
            one-off versus repeating bills, and a submit transform back to an
            imaginary API payload.
          </p>
          ...
          <JsonCard
            ...
            value={
              editorMode === 'api'
                ...
                : {
                    mode: 'creating new bill',
                    source: getNewBillDefaults(),
                  }
            }
          />
          <JsonCard
...
function toApiPayload(values: BillFormValues) {
  return {
